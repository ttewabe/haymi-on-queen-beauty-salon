    ...
    <nav className="fixed top-0 left-0 w-full bg-black text-white shadow-lg z-50">
      <div className="max-w-7xl mx-auto px-6 py-3">
        <ul className="flex items-center justify-center gap-8 text-sm font-semibold tracking-wide uppercase">
          ...
          {/* Navigation Links */}
          <li className="cursor-pointer hover:text-pink-400 transition" onClick={() => scrollToSection('home')}>
            Home
          </li>
          <li className="cursor-pointer hover:text-pink-400 transition" onClick={() => scrollToSection('services')}>
            Services
          </li>
          ...
          <li className="cursor-pointer" onClick={() => scrollToSection('portfolio')}>
            <img
              ...
              className="h-12 w-12 rounded-full border-2 border-white shadow-md hover:scale-105 transition"
            />
          </li>

          <li className="cursor-pointer hover:text-pink-400 transition" onClick={() => scrollToSection('about')}>
            About
          </li>
          <li className="cursor-pointer hover:text-pink-400 transition" onClick={() => scrollToSection('contact')}>
            Contact
          </li>
